  ...
  return (
    <>
      <div className="w-full">
        <div className="banner mt-8 relative h-128 bg-heroImg bg-no-repeat mx-auto flex flex-col items-start pt-8 sm:pt-16 md:pt-20 pl-8 sm:pl-16 md:pl-24 lg:pl-32 xl:pl-48 w-full" >
