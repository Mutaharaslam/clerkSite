  ...
  return (
    <section className="container mx-auto py-16 flex items-center justify-center">
        <div className="w-full flex flex-col items-center justify-center">
          ...
          <h2 role="contentinfo" className="text-center mb-4 text-2xl text-gray mt-5 font-serif italic">
            Our mission is to preserve the public trust as guardians
            of the people's records and assets.
          </h2>
          <button className="lg:text-xl ml-3 sm:ml-6 bg-red  focus:outline-none focus:ring-2 focus:ring-offset-2 ring-offset-indigo-700 focus:ring-white text-white px-8 py-1 rounded-full">Meet Clerk Eaton</button>
        </div>
      </section>
  );
};
